...
for target in targets:
    ...
    info['fragment']= target.split(":")[0]
    info['domain']=target.split(":")[1] #added
...
dataDF.to_csv(receptorName +'SpecificToResiduesResults.csv',index=False)
