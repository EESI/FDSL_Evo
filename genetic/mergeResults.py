...
def combine_pickle_files_to_csv(folder_path, jobID):
    ...
    results = combined_df.drop_duplicates(keep='first')
    ...
    output_csv_file = os.path.join(folder_path, str(jobID)+"combined_data.csv")
...
if __name__ == "__main__":
    ...
    combine_pickle_files_to_csv("jobResults", args.job)